module TestBench
  class CLI
    ...
    def random_generator
      @random_generator ||= TestBench::Pseudorandom::Generator.build
    end
    ...
    def self.build(arguments=nil, env: nil)
      ...
      instance.env = env
      Fixture::Writer.configure(instance)
    ...
    def self.call(arguments=nil, env: nil)
      ...
      Fixture::Session::Store.reset(session)
    ...
    def parse_arguments
      ...
      until argument_index == arguments.count
        ...
        when '-o', '--output-styling'
          ...
          Fixture::Writer::Styling.assure_styling(output_styling)
    ...
    def print_help_text
      ...
      \t                                  Render output coloring and font styling escape codes (Default: #{Fixture::Writer::Styling.default})
